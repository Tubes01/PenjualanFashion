    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>">Fashion</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url().'transaksi/laporan'?>"><i class="fa fa-bar-chart-o"></i>Laporan Transaksi</a>
                    </li>     
                    <li>
                        <a href="#"><i class="fa fa-sitemap"></i>Ekspor Laporan <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    <li>
                                <a href="<?php echo base_url().'transaksi/excel'?>">Export Excel</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url().'transaksi/pdf'?>" target="_blank">Export PDF</a> <i class="fa fa-excel"></i> 
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" >
            ...
            <!-- /. PAGE INNER  -->
            <footer><p><a href="http://akbardesign.org" target="_blank"></a></p></footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
    <!-- /. WRAPPER  -->
