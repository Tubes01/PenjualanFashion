...
--
-- Host: 127.0.0.1
-- Generation Time: 18 Jan 2020 pada 18.13
...
(16, 17, 'Jaket Bomber Mitchell Black', 289000, 55),
(15, 15, 'Jaket Denim Trucker Jeans Dark Blule', 325000, 55),
(14, 17, 'Celana Jogger Charcoal', 175000, 23),
(9, 9, 'tas kulit', 400000, 0),
(10, 9, 'tas kertas', 300000, 0),
(13, 17, 'Celana Jeans Denim - Blue', 125000, 25),
(17, 14, 'Kaos Polos', 27500, 21);
...
INSERT INTO `operator` (`operator_id`, `nama_lengkap`, `username`, `password`, `status`, `last_login`) VALUES
(7, 'Fazri Kusumah Putra', 'fazri', '202cb962ac59075b964b07152d234b70', 'admin', '2020-01-18'),
(15, 'Dera Des', 'dera', '202cb962ac59075b964b07152d234b70', 'kasir', '2020-01-18');
...
--
ALTER TABLE `transaksi_detail`
  MODIFY `t_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
